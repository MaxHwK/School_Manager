...
begin
   ...
   style.label_erreur (lbl_codepostal_erreur);
   lbl_codepostal_erreur.caption := '';
   style.label_erreur (lbl_commune_erreur);
   lbl_commune_erreur.caption := '';
   style.panel_travail (pnl_contact);
   style.label_titre  (lbl_contact);
   style.label_erreur (lbl_telephone_erreur);
   ...
   style.label_erreur (lbl_notes_erreur);
